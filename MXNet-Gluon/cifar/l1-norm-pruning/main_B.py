...
def parse_args():
    ...
    parser.add_argument('--save-dir', type=str, default='params_scratch_b',
                        help='directory of saved models')
    parser.add_argument('--log-dir', type=str, default='logs_scratch_b',
...
def main():
    ...
    model_name = opt.arch + '_' + str(opt.depth) + '_Pruned_Scratch_B'

    model_ref = models.__dict__[opt.arch](dataset=opt.dataset, depth=opt.depth)

    _, flops_std = print_model_param_flops(model_ref, 32)
    _, flops_small = print_model_param_flops(model, 32)

    epochs = int(opt.num_epochs * (flops_std / flops_small))

    print('Retraining Scratch-E Epochs: ', epochs)
    ...
    print("The Best Accuracy Before Scratch-B: ", val_acc)
