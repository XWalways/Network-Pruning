...
def parse_args():
    ...
    parser.add_argument('--lr-decay-epoch', type=str, default='25,40',
                        help='epochs at which learning rate decays. default is 25,40.')
    ...
    parser.add_argument('--save-dir', type=str, default='params_finetune',
                        help='directory of saved models')
    parser.add_argument('--log-dir', type=str, default='logs_finetune',
...
def main():
    ...
    model_name = opt.arch + '_' + str(opt.depth) + '_Pruned_Finetuned'

    if opt.refine:
        model.load_parameters(opt.refine, ctx=context)
    ...
    print("The Best Accuracy Before Finetuning: ", val_acc)
